...
export const AddDoctor = () => {
    ...
    const { aToken, backendUrl} = useContext(AdminContexts); 
    ...
    const onSubmitHandler = async() => {
        ...
        try{
            ...
            const {data} = await axios.post(backendUrl + '/api/admin/add-doctor' , formData, {headers:{aToken}})   // header convert key in small letter :-   aToken(we use aToken)
            console.log(data);
            if(data.success){
